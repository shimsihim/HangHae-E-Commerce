...
public class CouponService {
    ...
    // 쿠폰 발급 취소 처리 (롤백용)
    public void cancelIssuance(Coupon coupon) {
    ...
    // 쿠폰 사용 취소 처리 (롤백)
    public void cancelUsage(UserCoupon userCoupon) {
        userCoupon.rollbackUseCoupon();
    }


    //쿠폰이 적용여부 검증 및 할인 금액 계산
    public long applyDiscount(Coupon coupon, UserCoupon userCoupon, long orderAmount) {
        // 1. 최소 주문 금액 검증
